...
public:
  ...
  /*!
   * \brief get duration time of a segment
   */
  ...
  DerivedVec evaluate(const ScalarVec& t_vec)
  {
    ...
    // sort vmat into the states type
