...
#ifndef OPEN_WALKER_CORE_INTERFACES_I_ZMP_ESTIMATOR_H
#define OPEN_WALKER_CORE_INTERFACES_I_ZMP_ESTIMATOR_H
...
{
public:
  IZmpEstimator(const std::string& name) :
    ModuleBase(name)
  {
  }
...
#endif // OPEN_WALKER_CORE_INTERFACES_I_ZMP_ESTIMATOR_H
