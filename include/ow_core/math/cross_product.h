...
namespace ow
{
  ...
  */
  ...
  /**
   * @brief cross product in for 2d vector
   * 
   * Result is surface area of spanned parallelogam
   */
  template <typename Scalar>
  inline Scalar cross2(const Eigen::Matrix<Scalar,2,1>& v, const Eigen::Matrix<Scalar,2,1>& w)
  {
