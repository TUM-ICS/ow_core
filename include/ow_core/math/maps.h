...
namespace ow
{
 ...
 template<typename Derived>
   ...
   * 
   * \bug The epsilon for the zero devision is not good!
   */
  template<typename Derived>
  Eigen::Matrix<typename Derived::Scalar,3,1> logMapS3(const Eigen::QuaternionBase<Derived>& Q, typename Derived::Scalar tol = typename Derived::Scalar(1e-8))
  {
    typedef typename Derived::Scalar Scalar;
