...
{
  Derived X_parent;
  X_parent.angular() = changeRefFrame(X_child.angular(), T_parent_child);
  X_parent.linear() = changeRefFrame(X_child.linear(), T_parent_child);
  return X_parent;
}
...
{
  Derived X_parent;
  X_parent.angular() = changeRefFrame(X_child.angular(), X_parent_child);
  X_parent.linear() = changeRefFrame(X_child.linear(), X_parent_child);
  return X_parent;
}
 ...
 */
inline Wrench changeRefFrame(const Wrench& W_child,
                      const HomogeneousTransformation& T_parent_child)
{
  Wrench W_parent;
  W_parent.force() = changeRefFrame(W_child.force(),T_parent_child);
  W_parent.moment() = changeRefFrame(W_child.moment(),T_parent_child);
  return W_parent;
}
...
{
  Wrench W_parent;
  W_parent.force() = changeRefFrame(W_child.force(), X_parent_child);
  W_parent.moment() = changeRefFrame(W_child.moment(), X_parent_child);
  return W_parent;
}
...
{
  Derived X_parent;
  X_parent.pos() = changeRefFrame(X_child.pos(), T_parent_child);
  X_parent.vel() = changeRefFrame(X_child.vel(), T_parent_child);
  X_parent.acc() = changeRefFrame(X_child.acc(), T_parent_child);
  X_parent.effort() = changeRefFrame(X_child.effort(), T_parent_child);
  return X_parent;
}
...
{
  Derived X_parent;
  X_parent.pos() = changeRefFrame(X_child.pos(), X_parent_child);
  X_parent.vel() = changeRefFrame(X_child.vel(), X_parent_child);
  X_parent.acc() = changeRefFrame(X_child.acc(), X_parent_child);
  X_parent.effort() = changeRefFrame(X_child.effort(), X_parent_child);
  return X_parent;
}

inline ow::Points3d changeRefFrame(
  const ow::Points3d& points_child,
  const CartesianPosition& X_parent_child)
{
  return (X_parent_child.angular().toRotationMatrix()*points_child).colwise() + 
    X_parent_child.linear();
}
...
inline ow::Points3d changeRefFrame(
  ...
  const HomogeneousTransformation& T_parent_child)
{
  return (T_parent_child.rotation()*points_child).colwise() 
    + T_parent_child.position();
}

inline ow::Points2d changeRefFrame(
  const ow::Points2d& points_child,
  const CartesianPosition& X_parent_child)
{
