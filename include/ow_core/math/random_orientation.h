...
namespace ow
{
  ...
  * ow::AngularPosition Q = ow::uniformRandomQuaternion<std::default_random_engine>(generator);
  * 
  ...
  * 
  * std::default_random_engine generator(std::random_device());
  * ow::Rotation3 R = ow::uniformRandomQuaternion<std::default_random_engine>(generator);
  * 
  * See: http://planning.cs.uiuc.edu/node198.html
  */
  template<typename Scalar, typename Generator>
