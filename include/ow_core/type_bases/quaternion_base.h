...
#include <ow_core/common/support_templates.h>
#include <ow_core/common/forward_declarations.h>

#include <ow_core/math/maps.h>
#include <ow_core/math/euler.h>
...
public:
  ...
  */
   ...
   */
  ow_core::Vector3<Scalar> eulerYPR() const
  {
    return ow::eulerYPR(Base::derived().toRotationMatrix());
  }
